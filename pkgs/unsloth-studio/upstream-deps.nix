[
  ...
  { name = "av"; requirement = "av>=12.0.0"; marker = null; }
  ...
  { name = "pandas"; requirement = "pandas==2.3.3"; marker = null; }
  ...
  { name = "unsloth-zoo"; requirement = "unsloth_zoo>=2026.9.2"; marker = null; }
