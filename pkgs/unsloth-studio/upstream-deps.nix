[
  ...
  { name = "av"; requirement = "av>=12.3.0"; marker = null; }
  { name = "boto3"; requirement = "boto3>=1.34.0"; marker = null; }
  { name = "click"; requirement = "click>=8.0"; marker = null; }
  { name = "cryptography"; requirement = "cryptography<=46.0.3,>=42.0.0; sys_platform == \"win32\" and platform_machine == \"ARM64\""; marker = false; }
  { name = "cryptography"; requirement = "cryptography>=42.0.0; sys_platform != \"win32\" or platform_machine != \"ARM64\""; marker = null; }
  ...
  { name = "hf-transfer"; requirement = "hf_transfer; sys_platform != \"win32\" or platform_machine != \"ARM64\""; marker = null; }
  ...
  { name = "markdown-it-py"; requirement = "markdown-it-py>=3.0"; marker = null; }
  ...
  { name = "packaging"; requirement = "packaging==26.3"; marker = null; }
  { name = "pandas"; requirement = "pandas<4,>=3.0; sys_platform == \"win32\" and platform_machine == \"ARM64\" and python_version >= \"3.11\""; marker = false; }
  { name = "pandas"; requirement = "pandas==2.3.3; sys_platform != \"win32\" or platform_machine != \"ARM64\" or python_version < \"3.11\""; marker = null; }
  ...
  { name = "pydantic"; requirement = "pydantic==2.13.4"; marker = null; }
  { name = "pyjwt"; requirement = "pyjwt==2.13.0"; marker = null; }
  { name = "pymupdf"; requirement = "pymupdf==1.27.2.3; sys_platform != \"win32\" or platform_machine != \"ARM64\""; marker = null; }
  { name = "pymupdf"; requirement = "pymupdf>=1.28.2; sys_platform == \"win32\" and platform_machine == \"ARM64\""; marker = false; }
  ...
  { name = "sqlite-vec"; requirement = "sqlite-vec==0.1.9; sys_platform != \"win32\" or platform_machine != \"ARM64\""; marker = null; }
  ...
  { name = "unsloth-zoo"; requirement = "unsloth_zoo>=2026.9.5"; marker = null; }
